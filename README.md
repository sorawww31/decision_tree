...
2. **Scikit-learnとの比較:**
* 自作モデルとScikit-learnの `DecisionTreeRegressor` で、訓練スコアが大体一致。ロジックの正しさが証明された。
...
* **アンサンブル学習（群衆の知恵）**: 1本1本は「弱い学習器（Weak Learner）」であっても、多数決や平均をとることで、個々の木のミスを打ち消し合い、全体として非常に強力な予測性能を発揮。
